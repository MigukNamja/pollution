...
public class ExampleBakedModel implements IBakedModel {
    ...
    public static final ModelResourceLocation BAKED_MODEL = new ModelResourceLocation(Pollution.MODID + ":bakedmodelblock");
    ...
    public ExampleBakedModel(IModelState state, VertexFormat format, Function<ResourceLocation, TextureAtlasSprite> bakedTextureGetter) {
        this.format = format;
        sprite = bakedTextureGetter.apply(new ResourceLocation(Pollution.MODID, "blocks/isbmtexture"));
    }
